...
class Decoration_Order extends StatefulWidget {
  const Decoration_Order({super.key});

  @override
  State<Decoration_Order> createState() => _Decoration_OrderState();
}

class _Decoration_OrderState extends State<Decoration_Order> {
  int _currentIndex = 0;
                    ...
                    children: [
                      ...
                      Stack(
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.fromLTRB(16.h, 1.h, 0.h, 0.h),
                            child: Image.asset(
