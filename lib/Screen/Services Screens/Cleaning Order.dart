...
class CleaningOrder extends StatefulWidget {
  const CleaningOrder({super.key});

  @override
  State<CleaningOrder> createState() => _CleaningOrderState();
}

class _CleaningOrderState extends State<CleaningOrder> {
  int _currentIndex = 0;
